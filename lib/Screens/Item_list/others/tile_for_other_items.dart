...
class TileForOtherItems extends StatefulWidget {
  const TileForOtherItems(
      {super.key,
  ...
  @override
  State<TileForOtherItems> createState() => _TileForOtherItemsState();
}

class _TileForOtherItemsState extends State<TileForOtherItems> {
